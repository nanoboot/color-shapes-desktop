...
import org.nanoboot.powerframework.view.Screen;
...
public class CSView {
    ...
    public WindowColourSkin getWindowColourSkin() {
        //todo
        EnumColour currentColourSkin = null;// = currentLookService.getColourSkin();

        return new WindowColourSkin(currentColourSkin);
    }
}
