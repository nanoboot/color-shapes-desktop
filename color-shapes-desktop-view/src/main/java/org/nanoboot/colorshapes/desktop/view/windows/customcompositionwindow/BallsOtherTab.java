...
public class BallsOtherTab extends Tab {
    ...
    public BallsOtherTab() {
        super();
        this.setText(resourcePack.getText(20240));
    ...
    private void initLabels() {
        colourfulBallFrequencyLabel = new SLabel(resourcePack.getText(20241));
        rainbowBallFrequencyLabel = new SLabel(resourcePack.getText(20242));
        unmoveableBallsProbabilityLabel = new SLabel(resourcePack.getText(20243));
        unbreakableBallsProbabilityLabel = new SLabel(resourcePack.getText(20244));
    }
