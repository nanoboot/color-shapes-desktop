...
public class BoardTab extends Tab {
    ...
    public BoardTab() {
        super();
        this.setText(resourcePack.getText(20100));
...
//        cellLayout.addNode(clearAllHolesButton, 3, 4, 2, 1);
    ...
    private void initLabels() {
        heightLabel = new SLabel(resourcePack.getText(20101));
        widthLabel = new SLabel(resourcePack.getText(20102));
        gridProbabilityLabel = new SLabel(resourcePack.getText(20103));
        gridCountLabel = new SLabel(resourcePack.getText(20104));
        wallProbabilityLabel = new SLabel(resourcePack.getText(20105));
        wallCountLabel = new SLabel(resourcePack.getText(20106));
    }
    ...
    private void initButtons() {
        setHolesButton = new Button(resourcePack.getText(20107));
        clearAllHolesButton = new Button(resourcePack.getText(20108));
    }
