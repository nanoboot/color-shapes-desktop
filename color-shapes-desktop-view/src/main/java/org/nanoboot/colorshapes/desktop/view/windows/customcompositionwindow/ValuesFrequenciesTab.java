...
public class ValuesFrequenciesTab extends Tab {
    ...
    public ValuesFrequenciesTab() {
        super();
        this.setText(resourcePack.getText(20221));
    ...
    private void initLabels() {
        valuesMinusTwoFrequencyLabel = new SLabel(resourcePack.getText(20222));
        valuesMinusOneFrequencyLabel = new SLabel(resourcePack.getText(20223));
        valuesZeroFrequencyLabel = new SLabel(resourcePack.getText(20224));
        valuesPlusOneFrequencyLabel = new SLabel(resourcePack.getText(20225));
        valuesPlusTwoFrequencyLabel = new SLabel(resourcePack.getText(20226));
    }
