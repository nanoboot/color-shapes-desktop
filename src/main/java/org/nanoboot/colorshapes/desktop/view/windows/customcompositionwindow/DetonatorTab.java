...
public class DetonatorTab extends Tab {
     ...
     */
    public DetonatorTab() {
        super(ColorShapes.getServices().getLanguageService().getTextConstant(20400));
...
//        cellLayout.addNode(this.setCustomShapeToExplodeButton, 2, 6, 2, 1);
    ...
    private void initRadioButtons() {
        lineRadioButton = new RadioButton(ColorShapes.getServices().getLanguageService().getTextConstant(20402));
        blockRadioButton = new RadioButton(ColorShapes.getServices().getLanguageService().getTextConstant(20403));
        squareRadioButton = new RadioButton(ColorShapes.getServices().getLanguageService().getTextConstant(20404));
        ringRadioButton = new RadioButton(ColorShapes.getServices().getLanguageService().getTextConstant(20405));
        customRadioButton = new RadioButton(ColorShapes.getServices().getLanguageService().getTextConstant(20406));
    ...
    private void initButtons() {
        this.setCustomShapeToExplodeButton = new Button(ColorShapes.getServices().getLanguageService().getTextConstant(20421));
    }

    private void initLabels() {
        shapeToExplodeLabel = new SLabel(ColorShapes.getServices().getLanguageService().getTextConstant(20401));

        minimumLenghtLabel = new SLabel(ColorShapes.getServices().getLanguageService().getTextConstant(20411));
        minimumSizeLabel = new SLabel(ColorShapes.getServices().getLanguageService().getTextConstant(20412));
    }
